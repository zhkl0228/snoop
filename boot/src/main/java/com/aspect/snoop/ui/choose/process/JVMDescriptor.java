...
class JVMDescriptor implements Comparable<JVMDescriptor> {
	
	public JVMDescriptor(int id, String title, boolean isAttachable) {
		super();
		this.id = id;
		this.title = title;
	...
	@Override
	public int compareTo(JVMDescriptor o) {
		return id - o.id;
	}
}

...
public class InstrumentationManager {
    ...
    public List<URL> getCodeSourceURLs() {
        return new ArrayList<URL>(urlSources.keySet());
    }

    public final void updateClassPool(List<File> classFiles) {
        ...
        for(File file : classFiles) {
            AgentLogger.debug("Adding my " + file  + " to classpath lookup");
    ...
    public void instrument(Class<?> clazz,MethodChanges[] methodChanges) throws InstrumentationException {
        ...
        try {
            ...
            for ( MethodChanges change : methodChanges ) {
                ...
                // (clazz.getName() + ": " + change.getUniqueMethod().getName() + "(" + parameterTypes.length);
                ...
                for (LocalVariable newVar : newVars) {

...
public class JavaSnoop extends SingleFrameApplication {
    ...
    static {
        ...
        propFile = new File(System.getProperty("user.home"), ".snoop" + File.separator + "JavaSnoop.properties");
    ...
    private static void initializePropertiesFile(File propFile) throws IOException {
        getDefaultProperties().store(new FileWriter(propFile), null);
    }
